...
export const Profile = () => {
  return (
    <section className="flex flex-wrap gap-10">
      ...
      <div className=" flex-1 p-8 border border-gray-400 rounded-lg bg-white flex items-center justify-center text-center leading-8">
        웹 디자인부터 웹 퍼블리싱까지 경험한 프론트엔드 개발자입니다.
        <br />
